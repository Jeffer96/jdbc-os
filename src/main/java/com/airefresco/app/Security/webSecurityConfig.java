...
public class webSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Autowired
	AuthenticationProv authentication;
	...
	@Override
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
		authentication.UserDetailsService(cuds);
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        .sessionManagement()
            ...
            .and()
        .authorizeRequests()
        		.antMatchers("/supportSources/**","/script/**","/login/**","/registro","/")
        			.permitAll()
            	.antMatchers("/administrador","/controlUsuarios", "/editUser", "/deleteUser")
            		.hasAuthority("ADMIN")
